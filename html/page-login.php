...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
  ...
  $pdo = db_init();
  try {
     $stmt = $pdo->prepare("SELECT * FROM tbmkg_dbadmins
...
// exit;
     if ($info != FALSE) {
          ...
          $sql = "UPDATE tbmkg_dbadmins SET login_count=? WHERE login_id=?";
        ...
        <main>
            <section id="dbadmin">
                    <center>
                        ...
                        <p><img src="<?php echo get_template_directory_uri(); ?>/images/point.gif" alt=""> DB管理へのログイン</p><br>
                    </center>
                    <div class="h2-area-dbadmin">
                        <h2>管理者専用<br><span class="h2-sub">Administrator</span></h2>
                        <div>
          ...
          <footer>
                 <p><a href="<?php echo esc_url( home_url( '/' ) ); ?>"><small>UserLogin</small></a></p>
    <center><p>&copy;2019 Tsubomi Kindergarden. All rights reserved.</p></center>
  </footer>
    </div>
